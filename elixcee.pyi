...
def create_stream(path: str, max_pending_bytes: int | None = None, max_rows: int | None = None) -> StreamWriter: ...
...
class StreamWriter:
    ...
    def __init__(self, path: str, max_pending_bytes: int | None = None, max_rows: int | None = None) -> None: ...
