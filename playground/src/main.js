...
const copy = {
  en: {
    ...
    recipe: 'Choose a sample', sales: 'Sales total', budget: 'Budget summary', grades: 'Class average', sheetTab: 'Spreadsheet', downloadTab: 'Excel download', input: 'Input data', calculate: 'Recalculate', download: 'Download XLSX', reset: 'Reset', downloadTitle: 'Your workbook is ready', downloadText: 'Download the edited workbook as an XLSX file. Values and the calculated formula are included.',
  ...
  ja: {
    ...
    recipe: 'サンプルを選択', sales: '売上合計', budget: '予算集計', grades: 'クラス平均', sheetTab: 'Spreadsheet', downloadTab: 'Excelダウンロード', input: '入力データ', calculate: '再計算', download: 'XLSXをダウンロード', reset: 'リセット', downloadTitle: 'ワークブックの準備ができました', downloadText: '編集したワークブックをXLSXとしてダウンロードできます。値と計算済みの数式を含みます。',
  ...
  zh: {
    ...
    recipe: '选择示例', sales: '销售总额', budget: '预算汇总', grades: '班级平均分', sheetTab: 'Spreadsheet', downloadTab: '下载 Excel', input: '输入数据', calculate: '重新计算', download: '下载 XLSX', reset: '重置', downloadTitle: '工作簿已准备好', downloadText: '将编辑后的工作簿下载为 XLSX 文件，其中包含数据和计算后的公式。',
