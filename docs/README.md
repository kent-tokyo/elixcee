...
Documentation version: **1.0.10**. API/coverage pages describe this version;
...
The current branch may contain unreleased changes; the published 1.0.10
contract ends at the `[1.0.10]` section of the changelog.
