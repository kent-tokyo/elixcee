...
Documentation version: **1.0.9**. API/coverage pages describe this version;
...
The current branch may contain unreleased changes; the published 1.0.9
contract ends at the `[1.0.9]` section of the changelog.
