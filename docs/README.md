...
Documentation version: **1.0.8**. API/coverage pages describe this version;
...
The current branch may contain unreleased changes; the published 1.0.8
contract ends at the `[1.0.8]` section of the changelog.
