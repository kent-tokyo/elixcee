...
The expanded 55-case command was rerun after the later local changes using a
...
reported 51/51 comparable matches, 4 explicit skips, and zero mismatches.
...
elixcee matched all 51 comparable probes (51/51); the same four probes were
