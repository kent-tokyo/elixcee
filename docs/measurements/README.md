...
- [Microsoft Excel formula oracle, 2026-09-11](formula-excel-oracle-2026-09-11.md): 39 real Excel formula probes compared with the current source/evaluator regressions, including coercion, Empty/Error, mixed-type aggregates, dynamic-array, and array-Error boundaries.
