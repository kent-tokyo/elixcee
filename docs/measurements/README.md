...
- [Microsoft Excel formula oracle, 2026-09-11](formula-excel-oracle-2026-09-11.md): 20 real Excel formula probes compared with the current source wheel, including coercion and mixed-type aggregate boundaries.
