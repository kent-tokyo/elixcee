...
documented data-processing VBA subset. Current coverage is documented for **1.0.9**.
...
oracle. For v1.0.9, the local gate covers the Rust workspace/all-target tests,
