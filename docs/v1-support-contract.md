...
documented data-processing VBA subset. Current coverage is documented for **1.0.10**.
...
oracle. For v1.0.10, the local gate covers the Rust workspace/all-target tests,
