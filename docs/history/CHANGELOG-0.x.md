...
Historical release notes, moved from the root changelog on 2026-09-06.
Entries describe their release at the time, not the current supported surface.
See [current changelog](../../CHANGELOG.md) and [documentation map](../README.md).
