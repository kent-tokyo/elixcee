...
`sort_range`, merge create/remove), P2's first slice (hidden row/col read/write), and
P2's second slice (`copy_sheet`) — all below — are five further, independent additions
in this section, unrelated to each other or anything above.
