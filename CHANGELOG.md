...
- Formula coverage: add the localized `BAHTTEXT` number-to-Thai-Baht formatter.
...
- Formula coverage: add the Classic math function `SQRTPI`.
...
- Formula coverage: add bounded fixed-rate `EUROCONVERT` with precision controls.
