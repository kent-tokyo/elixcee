...
(`defined_names`, read-only), and P2's fourth slice (`sheet_state`, read-only) -- all
below -- are seven further, independent additions in this section, unrelated to each
