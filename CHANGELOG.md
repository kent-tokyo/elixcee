...
`sort_range`, merge create/remove), and P2's first slice (hidden row/col read/write) —
all below — are four further, independent additions in this section, unrelated to each
other or anything above.
