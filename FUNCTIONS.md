...
Coverage reference for **elixcee 1.0.9**. See [CHANGELOG](CHANGELOG.md) for versioned changes.
...
`Scripting.Dictionary` is active in the **1.0.9 VM-local adapter**, not a COM object.
