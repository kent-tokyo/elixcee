...
Coverage reference for **elixcee 1.0.7**. See [CHANGELOG](CHANGELOG.md) for versioned changes.
...
`Scripting.Dictionary` is active in the **1.0.7 VM-local adapter**, not a COM object.
