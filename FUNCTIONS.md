...
Coverage reference for **elixcee 1.0.8**. See [CHANGELOG](CHANGELOG.md) for versioned changes.
...
`Scripting.Dictionary` is active in the **1.0.8 VM-local adapter**, not a COM object.
