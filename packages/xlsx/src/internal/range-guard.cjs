...
// all iterate every (row, col) pair inside a worksheet's `!ref` rectangle, regardless of
// how sparse the actual data is. Confirmed live against the real oracle (xlsx@0.18.5,
