...
- [x] G2d Drawing text regression: 追加後の低ディスクRust workspace全targetで1,680 library testsと全integration／benchmark targetが成功した。[G2d測定](docs/measurements/g2d-object-editing-2026-09-09.md)
