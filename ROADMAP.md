...
- [x] 部分 G4 Excel oracle: Microsoft Excel for Mac 16.108でMAXIFS／MINIFS／DAYS／IFNA／XMATCH／TEXTJOINを自動計算し、現行source wheelの同一式と6/6一致を確認した。これは6 probe・1 hostの校正であり、全関数・全型変換・他OSのExcel互換性を意味しない。[測定記録](docs/measurements/formula-excel-oracle-2026-09-11.md)
