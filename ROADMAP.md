...
- [ ] **L7c 診断corpus execution BUILD**: 各manifest caseに再配布可能な合成workbook pair、VBA source、期待JSON、seed／case replayを接続し、manifestから実runnerを起動できるようにする。
...
1.0.8公開後の開発計画です。次の変更はUnreleasedに記録します。
